...
import { BsVirus, BsDropletHalf, BsEyedropper, BsClipboard2Pulse, BsFiletypePptx, BsEmojiLaughing, BsCurrencyDollar } from 'react-icons/bs';
    ...
    <aside id="sidebar">
      ...
      <ul className='sidebar-list'>
        ...
        <li className={`sidebar-list-item ${location.pathname === '/job' ? 'active' : ''}`}>
          <Link to="/job">
            <BsEmojiLaughing className='icon' /> Impact Sociale
          </Link>
        </li>
        <li className={`sidebar-list-item ${location.pathname === '/economy' ? 'active' : ''}`}>
          <Link to="/economy">
            <BsCurrencyDollar className='icon' /> Impact Economy
          </Link>
        </li>
